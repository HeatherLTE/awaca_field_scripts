...
start_date = dt.date(2024, 5, 13) # day to start making plots on
end_date = dt.date(2024, 5, 13) # day to stop making plots on


quicklook_variables = ['Z', 'VEL', 'WIDTH', 'SNR'] #variables to plot
# options for variables are 
#Ze, Z, VEL, WIDTH, SNR, RR
fpath_moments = '/home/corden/Documents/miniprojects_tests/mrr_guyancourt/data/'
quicklooks_outpath = '/home/corden/Documents/miniprojects_tests/mrr_guyancourt/plots/daily_zenith/'
dpi = 100
